...
2. **Настройте переменные окружения (опционально):**
   ```bash
   # Скопируйте и отредактируйте файл с переменными
...
5. **При первом запуске инициализируйте базу данных:**
   ```bash
...
6. **Войдите в систему используя созданные учетные данные**
...
После развертывания системы автоматически создаются тестовые пользователи для демонстрации функционала:
...
1. **Проверьте тестовые учетные записи:**
...
2. **Проверьте документацию API:** http://localhost:5001/api/docs
3. **Просмотрите логи:** `docker compose logs`
