...
Write-Log ""
Write-Log "📝 Теперь запустите скрипт инициализации:"
Write-Log "   cd backend"
Write-Log "   npm run init-db"
Write-Log ""
Write-Log "🔐 Или используйте готовый скрипт: .\scripts\run-init-db.ps1"
Write-Log ""
Write-Log "После инициализации запустите приложение: .\start-windows.bat"
